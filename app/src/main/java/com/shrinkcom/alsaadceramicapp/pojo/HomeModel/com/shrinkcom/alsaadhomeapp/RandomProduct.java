...
public class RandomProduct implements Serializable
{
    ...
    @SerializedName("size")
    @Expose
    private List<Size_> size = new ArrayList<Size_>();
    @SerializedName("brand")
    @Expose
    private Brand_ brand;
    @SerializedName("review")
    @Expose
    private List<Review_> review = new ArrayList<Review_>();
    ...
    private final static long serialVersionUID = 5166979640140937608L;
    ...
    public List<Size_> getSize() {
        return size;
    }

    public void setSize(List<Size_> size) {
        this.size = size;
    }
